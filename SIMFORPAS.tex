...
\newpage
\subsection{Diagrama de evolución}
\imgCentradaGrande{fig.4.11}{img/diagevolucion2.eps}{Diagrama de evolución para el segundo sprint.}

\newpage
\section{Sprint 3: Creación del SIMCORE}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.11}{img/diagvelocidad3.eps}{Diagrama de velocidad para el tercer sprint.}

\newpage
\section{Sprint 4: Implementación del modelo de Locomove}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.12}{img/diagvelocidad4.eps}{Diagrama de velocidad para el cuarto sprint.}

\newpage
\section{Sprint 5: Gestión de carga de la misión}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.13}{img/diagvelocidad5.eps}{Diagrama de velocidad para el quinto sprint.}

\newpage
\section{Sprint 6: Puesto de instructor}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.14}{img/diagvelocidad6.eps}{Diagrama de velocidad para el sexto sprint.}

\newpage
\section{Sprint 7: Primera versión y cambios en el objetivo}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.15}{img/diagvelocidad7.eps}{Diagrama de velocidad para el séptimo sprint.}

\newpage
\section{Sprint 8: Cambios en el diseño}

\subsection{Diagrama de burndown}
%\imgCentradaGrande{fig.4.16}{img/diagvelocidad8.eps}{Diagrama de velocidad para el octavo sprint.}
