...
\imgCentrada{fig.0.1}{img/incendio.eps}{Soporte aéreo en el control de incendios.}
...
\imgCentrada{fig.0.2}{img/predator.eps}{UAV tipo Predator en vuelo.}
...
\imgCentrada{fig.0.3}{img/predatorgcs.eps}{GCS usada para el UAV Predator.}
...
\imgCentrada{fig.1.1}{img/manifest.eps}{Manifiesto ágil.}
...
\imgCentrada{fig.1.2}{img/scrum.eps}{Ciclo metodología Scrum.}
...
\imgCentradaMed{fig.1.3}{img/tdd.eps}{Ciclo TDD.}
...
\imgCentradaMed{fig.1.4}{img/pair.eps}{Pair programming.}
...
\imgCentradaMed{fig.1.5}{img/poo.eps}{Pilares de la POO.}
...
\imgCentradaMed{fig.1.6}{img/cpp11.eps}{Ilustración c++11.}
...
\imgCentradaMed{fig.1.7}{img/java.eps}{Logo Java.}
...
\imgCentradaMed{fig.1.8}{img/mvc.eps}{Diagrama MVC.}
...
\imgCentradaPeq{fig.1.9}{img/ubuntu.eps}{Logo Ubuntu.}
...
\imgCentradaPeq{fig.1.10}{img/qtcreator.eps}{Logo Qt Creator.}
...
\imgCentradaPeq{fig.1.11}{img/eclipse.eps}{Logo Eclipse.}
...
\imgCentradaPeq{fig.1.12}{img/mercurial.eps}{Logo Mercurial.}
...
\imgCentradaPeq{fig.1.13}{img/bitbucket.eps}{Logo Bitbucket.}
...
\imgCentrada{fig.1.14}{img/cmakelists.eps}{Ejemplo CMakeLists.txt.}
...
\imgCentradaMed{fig.1.15}{img/pom.eps}{Ejemplo POM.xml.}
\newpage
...
\imgCentradaMed{fig.1.16}{img/rti.eps}{Logo de RTI.}
...
\imgCentradaMed{fig.1.17}{img/spring.eps}{Logo Spring.}
...
\imgCentradaMed{fig.1.18}{img/struts2.eps}{Logo Struts 2.}
...
\imgCentradaMed{fig.1.19}{img/hibernate.eps}{Logo Hibernate.}
...
\imgCentradaMed{fig.1.20}{img/valgrind.eps}{Logo Valgrind.}
...
\imgCentrada{fig.1.21}{img/valgrindreport.eps}{Resltado Valgrind.}
...
\imgCentrada{fig.1.22}{img/mavlink.eps}{Logo Mavlink.}
...
\imgCentrada{fig.1.23}{img/mavlinkwaypointwrite.eps}{Protocolo de escritura de misión en Mavlink.}
...
\imgCentrada{fig.1.24}{img/qgroundcontrol.eps}{QGroundControl, gcs de Mavlink.}
...
\imgCentrada{fig.1.25}{img/gcscatec.eps}{GCA de Catec.}
...
\imgCentrada{fig.1.26}{img/locomove.eps}{UAV de Catec, Locomove.}
...
\imgCentrada{fig.1.27}{img/autopilotocatec.eps}{Autopiloto integrado en el Locomove.}
...
\imgCentradaGrande{fig.2.1}{img/documentobacklog.eps}{Ejemplo del documento de backlog.}
...
\section{Iteraciones: Sprints de desarrollo}

\subsection{Sprint 1: Set Up del proyecto}
...
\imgCentradaGrande{fig.2.2}{img/arquitectura.eps}{Arquitectura del sistema, con las relaciones físicas entre subsistemas.}
...
\imgCentradaGrande{fig.2.3}{img/funcionamientobasicomision.eps}{Diagrama de secuencia de la ejecución de una misión.}
...
\imgCentradaGrande{fig.2.4}{img/cargamision.eps}{Diagrama de secuencia de la carga de una misión en el simulador y el control.}
...
\imgCentradaGrande{fig.2.5}{img/iniciopausaparada.eps}{Diagrama de secuencia con los comandos desde el puesto de instructor para iniciar, parar o pausar una ejecución.}
...
\imgCentradaGrande{fig.2.6}{img/introduccionfallos.eps}{Diagrama de secuencia para la introducción de fallos.}
...
\imgCentradaGrande{fig.2.7}{img/cambiosmision.eps}{Diagrama de secuencia para hacer cambios en la misión.}
...
\subsubsection{Diagrama de comunicaciones}
...
\imgCentradaGrande{fig.2.8}{img/relacionescomunicacion.eps}{Diagrama de las relaciones a la hora de comunicarse de los distintos módulos.}
...
\newpage
\subsubsection{Entradas y salidas de los módulos}
...
\newpage
\subsection{Sprint 2: Creación de la capa de comunicación}
