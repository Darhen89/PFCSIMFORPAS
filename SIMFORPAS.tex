...
\subsection{Iteraciones: Sprints de desarrollo}

\subsubsection{Sprint 1: Set Up del proyecto}

\lettrine{E}{n} la reunión se define también la estructura del sistema. Se necesitará una serie de módulos que tengan una función definida cada uno de ellos con el fin de hacer el sistema lo más escalable posible de manera que si en algún momento hay que realizar un cambio grande no afecte al resto de componentes, cada módulo será un proyecto independiente para descentralizar el desarrollo, así se determina la necesidad de disponer de los siguientes elementos:
...
\imgCentrada{fig.2.1}{img/arquitectura.eps}{Arquitectura del sistema, con las relaciones físicas entre subsistemas.}
...
\newpage
\subsubsection{Sprint 2: Creación de la capa de comunicación}
